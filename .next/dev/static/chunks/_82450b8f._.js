...
const FloatingAssets = ({ onAssetValuesChange, assetValues: externalAssetValues })=>{
    ...
    const getAssetsForCurrentBreakpoint = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "FloatingAssets.useCallback[getAssetsForCurrentBreakpoint]": ()=>{
    ...
    const [localValues, setLocalValues] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({});
        ...
        "FloatingAssets.useEffect": ()=>{
            if (externalAssetValues && Object.keys(externalAssetValues).length > 0) {
                ...
                if (JSON.stringify(localValues) !== JSON.stringify(externalAssetValues)) {
                    ...
                    setRenderKey({
                        "FloatingAssets.useEffect": (k)=>k + 1
                    }["FloatingAssets.useEffect"]);
                }
            }
        }
        ...
        "FloatingAssets.useEffect": ()=>{
            if (mounted && onAssetValuesChange && !isInitialized) {
                ...
                assetsToRender.forEach({
                    "FloatingAssets.useEffect": (asset)=>{
    ...
    const handleMouseDown = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "FloatingAssets.useCallback[handleMouseDown]": (e, asset, action, direction)=>{
    ...
    }["FloatingAssets.useCallback[handleMouseDown]"], [
        isLayoutMode,
        getAssetValue
    ]);
    const handleMouseMove = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "FloatingAssets.useCallback[handleMouseMove]": (e)=>{
            ...
            if (dragState.action === 'move') {
                ...
                const newValues = {
                    ...localValues,
                    [dragState.assetSrc]: {
                        ...localValues[dragState.assetSrc] || getAssetDefaults(assetsToRender.find({
                            "FloatingAssets.useCallback[handleMouseMove]": (a)=>`${a.src}-${a.alt}` === dragState.assetSrc
                        }["FloatingAssets.useCallback[handleMouseMove]"])),
                ...
                setRenderKey({
                    "FloatingAssets.useCallback[handleMouseMove]": (k)=>k + 1
                }["FloatingAssets.useCallback[handleMouseMove]"]);
    ...
    const handleMouseUp = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "FloatingAssets.useCallback[handleMouseUp]": ()=>{
            setDragState(null);
        }
    }["FloatingAssets.useCallback[handleMouseUp]"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
...
_s(FloatingAssets, "2dlDkRgMgcYInMDG47QXEvVUv64=", false, function() {
    return [
...
//# sourceMappingURL=_82450b8f._.js.map